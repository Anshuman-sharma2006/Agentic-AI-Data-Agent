...
if __name__ == "__main__":
    obj = ETLTools()
    path = "C:\\Users\\AMAN\\OneDrive\\Desktop\\Ai Orchastration\\data\\extract\\extracted_data.csv"
    print(obj.transform_load_context(path))
          #C:\\Users\\AMAN\\OneDrive\\Desktop\\Ai Orchastration\data\extract\extracted_data.csv