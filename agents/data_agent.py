...
# '''RouterSchema(answer="sql")->(model_dump())convert this into->{"answer": "sql"}
# ifclass DataAgentSchema(BaseModel):
    # '''messages: ...
    # user_question: str
    # route_response: str''''
def router_node(state:DataAgentSchema):
    ...
    print("ROUTER RESPONSE:", route_response)
...
def sql_node(state:DataAgentSchema):
    ...
    input_schema = {
        "messages": [],"user_question": f"{message}","curated_ques": "","prompt_query_context": "",
        "generated_sql_query": "",
        "is_safe": "No",
        "comments": "",
